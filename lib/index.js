...
var axios = require('axios'); //const GB_API_SERVER = (window && window.location.hostname === "localhost") ? "http://localhost:8087/sdk/v1" : "https://api.greenbii.com/sdk/v1"
...
var greenbii = /*#__PURE__*/function () {
  ...
  _createClass(greenbii, [{
    ...
    value: function createDialog() {
      ...
      var maskWidth = window.document.documentElement.scrollWidth; //document.body.append('')
    }
  }]);
